...
# Route to process the image and detect traffic light color
@app.route('/process_image')
def process_image():
    img_path = r"C:\Users\bunny\Desktop\object detection\image.jpg"
    ...
    # Loop through detected objects and classify the traffic light color
    for box in boxes:
    ...
    # Save the image or send it back to the frontend (or show it)
    output_path = "static/output_image.jpg"
    cv2.imwrite(output_path, img)

    return render_template('show_results.html', image_path=output_path)
